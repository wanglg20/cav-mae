...
cur_dir=$(pwd)
pretrain_path=/home/chenyingying/tmp/cav-mae/src/exp/trainmamba-k700-CrossMamba-lr5e-5-bs50-c0.01-p10.0-m0.75/models/model.6.pth
freeze_base=False
...
dataset=k700
tr_data=/data/wanglinge/project/cav-mae/src/data/info/k700_train.json
...
exp_dir=./exp/mamba_ft_k700_${noise}_lr_${lr}-bs${batch_size}-h${head_lr}
mkdir -p $exp_dir
train_frame=/data/wanglinge/project/cav-mae/src/data/k700/train_16f
val_frame=/data/wanglinge/project/cav-mae/src/data/k700/val_16f
...
# --use_wandb --wandb_run_name mamba_ft_k700 \