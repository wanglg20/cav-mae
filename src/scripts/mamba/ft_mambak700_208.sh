...
cur_dir=$(pwd)
pretrain_path=/home/chenyingying/tmp/cav-mae/src/exp/trainmamba_k700_aligned/model.25.pth
freeze_base=True
...
PYTHONWARNINGS=ignore torchrun --master_port=29505 --nproc_per_node=8 ./run_finetune_mamba.py --model ${model} --dataset ${dataset} \
