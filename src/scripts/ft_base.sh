...
cur_dir=$(pwd)
pretrain_path=/data/wanglinge/project/cav-mae/src/exp/testmae-audioset-cav-mae-balNone-lr5e-5-epoch25-bs48-normTrue-c0.01-p1.0-tpFalse-mr-unstructured-0.75/models/audio_model.25.pth
...
PYTHONWARNINGS=ignore torchrun --nproc_per_node=7 run_cavmae_ft.py --model ${model} --dataset ${dataset} \
